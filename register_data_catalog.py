...
def add_to_catalog(dataset_name: str, desc: str, location: str, catalog_file='data_catalog.jsonl'):
    """
...
# Example usage
add_to_catalog("user_interactions", "Processed logs of user events", "s3://data-lake/clean/user_events/")
